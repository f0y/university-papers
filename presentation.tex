...
\center{\includegraphics[width=1\linewidth]{hivemind-maemo}}
\end{minipage}
\hfill
\begin{minipage}[h]{0.45\linewidth}
\center{\includegraphics[width=1\linewidth]{hivemind-linux}}
\end{minipage}
\vfill
\begin{minipage}[h]{0.45\linewidth}
\center{\includegraphics[width=1\linewidth]{hivemind-meego}}
\end{minipage}
\hfill
\begin{minipage}[h]{0.45\linewidth}
\center{\includegraphics[width=1\linewidth]{hivemind-windows}}
\end{minipage}
\end{figure}
\end{frame}
