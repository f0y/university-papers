...
core --- NetworkController. It manages publish-subscribe protocol handlers.
...
All QUndoCommands are passed to the controller. If there is no network
collaboration at the moment, the command will be added to the local undo/redo
stack. Otherwise, command will be serialized and sent to the service. Update
notifications are deserialized into QUndoCommands and added to the undo/redo
stack.

The use of edit commands causes the problem of sharing
